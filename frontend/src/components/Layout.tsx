...
const Layout: React.FC<{
  ...
  return (
    <div className="flex flex-col md:grid md:grid-cols-1 md:grid-rows-[10vh_87vh_15vh] sm:gap-4 bg-wall-paper-sm md:bg-wall-paper bg-no-repeat bg-center bg-cover min-h-screen bg-purple-950">
